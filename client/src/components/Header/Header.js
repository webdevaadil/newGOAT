...
display: "-wflex ebkit-box -moz-box  -ms-flexbox -webkit-flex"}} className="container navbar navbar-expand-lg navbar-light">
          ...
          >          
            ...
            <label for="checkbox1"><div className="hamburger hamburger1"><span className="bar bar1"></span><span className="bar bar2"></span><span className="bar bar3"></span><span className="bar bar4"></span></div></label>
            </div> 
          </button>
