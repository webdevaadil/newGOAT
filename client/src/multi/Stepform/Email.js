          ...
          <section style={{ marginBottom: "10px" }}>
              ...
              <div className="container section">
                <div style={{ paddingLeft: "110px" }} id="sport-sec">
                  <Breadcrumb separator=">">
                    ...
                    <Breadcrumb.Item>
                      <span className="btn" style={{ padding: "7px" }}>
                        Packages
                      </span>
                    </Breadcrumb.Item>
                  </Breadcrumb>
                ...
                <div className="flex_box">
                  <div className="box_one">
                    <h2>Pub Punters</h2>
                    <h3>Free</h3>
                    <button className="b1-btn_one" style={{ width: "216px" }}>
                      78% Returns
                    </button>
                  ...
                  <div className="box_one">
                    <h2>Bronze</h2>
                    <h3>$15 / week</h3>
                    <button className="b2-btn_one" style={{ width: "216px" }}>
                      98% Returns
                    </button>
                    <ul className="list_item">
                      <li>1234 Users</li>
                  ...
                  <div className="box_one">
                    <h2>Silver</h2>
                    <h3>$30 / week</h3>
                    <button className="b3-btn_one" style={{ width: "216px" }}>
                      120% Returns
                    </button>
                    <ul className="list_item">
                      <li>1234 Users</li>
                  ...
                  <div className="box_one">
                    <h2>Gold</h2>
                    <h3>$45 / week</h3>
                    <button className="b4-btn_one" style={{ width: "216px" }}>
                      165% Returns
                    </button>
                    <ul className="list_item">
                      <li>1234 Users</li>
                  ...
                  <div className="box_one">
                    <h2>Platinum</h2>
                    <h3>$60 / week</h3>
                    <button className="b5-btn_one" style={{ width: "216px" }}>
                      265% Returns
                    </button>
                    <ul className="list_item">
                      <li>1234 Users</li>
            ...
            <Modal style={{ height: "800px" }} show={show} onHide={handleClose}>
              ...
              >
                ...
                {formData.packages !== "" ? (
                  <button
                    className="btn_two btn"
                    style={{
                      height: "50px",
                      backgroundColor: " #10867F",
                      color: "black",
                      float: "right",
                      margin: 0,
                    }}
